...
Kqueue and [epoll](https://en.wikipedia.org/wiki/Epoll) are both high-performance kernel event notifications mechanisms designed to monitor thousands of file descriptors simultaneously in O(1) time complexity.
